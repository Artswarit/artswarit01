      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage custom artwork requests with milestone-based payments
          </p>
        </div>
          ...
          >
            ...
            <CardContent>
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  <Badge
                    className={getEscrowStatusColor(commission.escrowStatus)}
                  >
                ...
                <CardContent className="p-4">
                  ...
                  <div className="space-y-2 mb-4 max-h-40 overflow-y-auto">
                    <div className="bg-blue-50 p-2 rounded text-sm">
                      <span className="font-medium">Client:</span> Looking
                      forward to seeing the initial concepts!
                    </div>
                    <div className="bg-green-50 p-2 rounded text-sm">
                      <span className="font-medium">Artist:</span> I've uploaded
                      the mood board for review.
                    </div>
                  </div>
                  <div className="flex gap-2">
                    <Input
