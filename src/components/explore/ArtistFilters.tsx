      ...
      <CardContent className="space-y-8 p-5 sm:p-6">
          ...
          <Select
            ...
            <SelectContent className="rounded-xl border-primary/10 shadow-2xl">
              ...
              <SelectItem
                key={category}
                value={category}
                className="rounded-lg py-3 focus:bg-primary/10">
        ...
        <div
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-3">
              ...
              <div
                ...
                onClick={() => handleBadgeToggle(badge.value)} role="button" tabIndex={0} onKeyDown={(e) => {if (e.key === "Enter" || e.key === " ") {e.preventDefault();(() => handleBadgeToggle(badge.value))(e);}}}>
          ...
          <div className="space-y-3">
            ...
            <Select
              ...
              onValueChange={(value) =>
              updateFilters({ ...filters, availability: value })
              }>
              ...
              <SelectContent className="rounded-xl border-primary/10 shadow-2xl">
                ...
                <SelectItem value="available" className="rounded-lg py-3">
                  Available for Commission
                </SelectItem>
                <SelectItem value="unavailable" className="rounded-lg py-3">
                  Not Available
                </SelectItem>
              </SelectContent>
            </Select>
        ...
        <div className="space-y-3 pt-2">
            ...
            <Badge
              key={badge}
              variant="secondary"
              className="bg-primary/10 text-primary border-primary/20 px-3 py-1.5 rounded-lg flex items-center gap-2 transition-all hover:bg-primary/20">
            ...
            <Badge
              variant="secondary"
              className="bg-primary/10 text-primary border-primary/20 px-3 py-1.5 rounded-lg flex items-center gap-2">
