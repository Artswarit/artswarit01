        ...
        <div className="flex flex-col lg:flex-row gap-3 sm:gap-4 items-stretch lg:items-center">
          ...
          <div className="flex overflow-x-auto sm:overflow-visible pb-1 sm:pb-0 gap-2 items-center flex-1 scrollbar-hide">
            ...
            <Select
              ...
              onValueChange={(value) =>
                handleFilterChange("artworkType", value)
              }
            >
            ...
            <div className="flex items-center bg-muted/30 rounded-xl p-0.5 border border-border/10">
              <Button
                ...
                className={cn(
                  ...
                  viewMode === "grid"
                    ? "shadow-sm bg-white dark:bg-background text-primary"
                    : "hover:bg-primary/5",
                )}
              >
        ...
        <div className="mt-2 flex xl:hidden flex-wrap items-center gap-2">
          ...
          <div className="flex flex-wrap gap-1.5">
            {filters.category !== "all" && (
              <Badge
                variant="secondary"
                className="pl-2.5 pr-0.5 py-0.5 rounded-full bg-primary/5 text-primary border-primary/10 hover:bg-primary/10 transition-colors text-[10px]"
              >
                {filters.category}
                <Button
                  variant="ghost"
            ...
            {filters.artworkType !== "all" && (
              ...
              >
                ...
                <Button
                  ...
                  size="icon"
                  className="h-4 w-4 ml-1 hover:bg-transparent"
                  onClick={() => handleFilterChange("artworkType", "all")}
                >
                  <X className="h-3 w-3" />
                </Button>
              </Badge>
            ...
            <GlassCard className="p-5 border-primary/10 bg-white/40 dark:bg-card/40 backdrop-blur-2xl shadow-xl rounded-3xl">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="space-y-2.5">
                  <label className="text-[10px] font-black uppercase tracking-[0.15em] text-muted-foreground/80 ml-1">
                    Search by Tags
                  </label>
                  <div className="relative group">
                    <Input
                      ...
                      onChange={(e) =>
                        handleAdvancedFilterChange("tags", e.target.value)
                      }
                  ...
                  <p className="text-[9px] font-bold text-muted-foreground/40 ml-1 uppercase tracking-wider">
                ...
                <div className="space-y-2.5">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleAdvancedFilterChange("location", e.target.value)
                    }
