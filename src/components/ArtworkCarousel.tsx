...
const ArtworkCarousel = () => {
  ...
  if (loading) {
    return (
      <section
        id="artwork"
        className="py-20 bg-gradient-to-r from-violet-50 via-white to-indigo-50 relative overflow-hidden"
      >
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <p className="section-subtitle mb-8">
            Be the first to upload your artwork!
          </p>
          <Button asChild>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex justify-between items-center mb-12">
          ...
          <Button
            asChild
            variant="outline"
            className="hidden md:flex border-primary hover:bg-primary hover:text-white transition-all duration-300"
          >
