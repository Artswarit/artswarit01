        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-12 lg:gap-8 text-center sm:text-left">
          ...
          <div className="space-y-6 flex flex-col items-center sm:items-start">
            ...
            <p className="text-sm leading-relaxed text-white/60 max-w-xs font-medium">
              The premier digital destination for artists to showcase, monetize,
              and scale their creative careers globally.
            </p>
            {/* Social Icons */}
          ...
          <div className="space-y-4 sm:space-y-5">
            <h3 className="font-heading text-xs sm:text-sm font-bold uppercase tracking-widest text-white/40">
              For Artists
            </h3>
