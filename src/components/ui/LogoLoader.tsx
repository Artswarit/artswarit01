  ...
  const loader = (
    ...
    >
      ...
      <div className="relative flex items-center justify-center">
        ...
        {/* Middle glow pulse */}
        <span
          className="absolute h-16 w-16 rounded-full bg-primary/5 animate-ping"
      ...
      {text && (
        <p
          className="text-sm font-semibold text-muted-foreground/80 tracking-wide animate-pulse"
          style={{ animationDuration: "2s" }}
        >
          {text}
        </p>
