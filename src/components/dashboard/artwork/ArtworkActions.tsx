      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            variant="ghost"
            size="icon"
            className="h-12 w-12 hover:bg-white/80 transition-all active:scale-95 rounded-xl"
          >
        ...
        <DropdownMenuContent
          align="end"
          className="w-64 p-2 rounded-[1.5rem] border-primary/10 shadow-2xl backdrop-blur-xl bg-background/95 animate-in fade-in zoom-in-95 duration-200"
        >
          <DropdownMenuItem
            onClick={() => setIsEditModalOpen(true)}
            className="cursor-pointer min-h-[48px] sm:min-h-[44px] gap-3 px-4 rounded-xl hover:bg-primary/5 focus:bg-primary/5 transition-colors"
          >
