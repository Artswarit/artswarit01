        ...
        <div className="space-y-6 sm:space-y-8">
          ...
          <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            <div className="space-y-2">
              <label className="text-[10px] sm:text-[11px] font-black uppercase tracking-[0.2em] text-muted-foreground/60 ml-2">
                Category
              </label>
              <Select
              ...
              >
                ...
                <SelectContent className="rounded-2xl border-primary/10 shadow-2xl">
                  ...
                  <SelectItem value="Music" className="font-bold py-3">
                    Music
                  </SelectItem>
                  <SelectItem value="Digital Art" className="font-bold py-3">
                    Digital Art
                  </SelectItem>
                  <SelectItem value="Photography" className="font-bold py-3">
                    Photography
                  </SelectItem>
                  <SelectItem value="Video" className="font-bold py-3">
                    Video
                  </SelectItem>
                </SelectContent>
              </Select>
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent className="rounded-2xl border-primary/10 shadow-2xl">
                  ...
                  <SelectItem value="public" className="font-bold py-3">
                    Public
                  </SelectItem>
                  <SelectItem value="private" className="font-bold py-3">
                    Private
                  </SelectItem>
                  <SelectItem value="archived" className="font-bold py-3">
                    Archived
                  </SelectItem>
                </SelectContent>
              </Select>
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent className="rounded-2xl border-primary/10 shadow-2xl">
                  ...
                  <SelectItem value="image" className="font-bold py-3">
                    Image
                  </SelectItem>
                  <SelectItem value="music" className="font-bold py-3">
                    Music
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent className="rounded-2xl border-primary/10 shadow-2xl">
                  ...
                  <SelectItem value="most_liked" className="font-bold py-3">
                    Most Liked
                  </SelectItem>
                  <SelectItem value="most_viewed" className="font-bold py-3">
                    Most Viewed
                  </SelectItem>
                  <SelectItem value="price_high" className="font-bold py-3">
                    Price: High to Low
                  </SelectItem>
                  <SelectItem value="price_low" className="font-bold py-3">
                    Price: Low to High
                  </SelectItem>
                </SelectContent>
              </Select>
          ...
          <div className="space-y-4 pt-4 border-t border-primary/5">
            <div className="flex items-center gap-2 ml-2">
              ...
              <span className="text-[11px] sm:text-xs font-black uppercase tracking-[0.2em] text-muted-foreground/80">
                Filter by Tags
              </span>
            </div>
