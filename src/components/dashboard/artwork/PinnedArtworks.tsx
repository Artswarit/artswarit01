  ...
  const [artworks, setArtworks] = useState<ArtworkItem[]>([
    {
      ...
      imageUrl:
        "https://images.unsplash.com/photo-1536924940846-227afb31e2a5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80",
      isPinned: true,
    },
    {
      id: "2",
      title: "Urban Poetry",
      imageUrl:
        "https://images.unsplash.com/photo-1578926288207-a90a5366759d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80",
      isPinned: true,
    },
    {
      id: "3",
      title: "Music Flow",
      imageUrl:
        "https://images.unsplash.com/photo-1557672172-298e090bd0f1?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1074&q=80",
      isPinned: true,
    },
    {
      id: "4",
      ...
      imageUrl:
        "https://images.unsplash.com/photo-1567095761054-7a02e69e5c43?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1074&q=80",
      isPinned: false,
    },
    {
      id: "5",
      ...
      imageUrl:
        "https://images.unsplash.com/photo-1614173188975-0e2aae485595?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80",
      isPinned: false,
    },
  ]);
  ...
  const handleTogglePin = (id: string) => {
    ...
    if (artwork && !artwork.isPinned && pinnedCount >= 3) {
      toast({
        ...
        description:
          "You can pin a maximum of 3 artworks. Unpin an artwork first.",
        variant: "destructive",
      });
      return;
    }
    ...
    toast({
      title:
        artwork && artwork.isPinned ? "Artwork unpinned" : "Artwork pinned",
      description:
        artwork && artwork.isPinned
      ...
      <Card className="rounded-[2.5rem] shadow-xl shadow-primary/5 border-primary/10 overflow-hidden backdrop-blur-md bg-background/50">
        <CardHeader className="space-y-2 pb-6 border-b border-primary/5">
          ...
          <CardDescription className="text-sm font-medium text-muted-foreground">
            Drag and drop to reorder your pinned artworks. You can pin up to{" "}
            <span className="text-primary font-black">3</span> artworks.
          </CardDescription>
        </CardHeader>
          ...
          {pinnedArtworks.length > 0 ? (
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                                ...
                                <Badge
                                  variant="secondary"
                                  className="w-fit bg-primary/10 text-primary hover:bg-primary/20 border-none px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest"
                                >
                                  Pinned
                                </Badge>
                              </div>
            ...
            <div className="text-center py-16 px-4 bg-muted/20 rounded-3xl border border-dashed border-primary/20">
              <p className="text-muted-foreground font-medium text-lg">
                No pinned artworks yet.
              </p>
              <p className="text-sm text-muted-foreground/60 mt-1">
                Pin your best work to showcase it on your profile.
              </p>
            </div>
          )}
        </CardContent>
      ...
      <Card className="rounded-[2.5rem] shadow-xl shadow-primary/5 border-primary/10 overflow-hidden backdrop-blur-md bg-background/50">
        ...
        <CardContent className="p-6">
          {unpinnedArtworks.length > 0 ? (
            ...
            <div className="text-center py-16 px-4 bg-muted/20 rounded-3xl border border-dashed border-primary/20">
              <p className="text-muted-foreground font-medium text-lg">
                All your artworks are pinned.
              </p>
              <p className="text-sm text-muted-foreground/60 mt-1">
                Upload more work to continue building your collection.
              </p>
            </div>
          )}
        </CardContent>
