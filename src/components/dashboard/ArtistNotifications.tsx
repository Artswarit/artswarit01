          ...
          <CardContent className="px-0">
            <div className="divide-y divide-border/50">
              ...
              <div
                ...
                }} role="button" tabIndex={0} onKeyDown={(e) => {if (e.key === "Enter" || e.key === " ") {e.preventDefault();(() => {markAsRead(notification.id);onNotificationClick?.(notification);})(e);}}}>
                    ...
                    <div className="flex gap-3 sm:gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex justify-between items-start gap-2">
                          <h4
                        className={`text-sm sm:text-base font-semibold leading-tight truncate ${!notification.is_read ? "text-foreground" : "text-foreground/70"}`}>
