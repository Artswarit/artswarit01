...
const DashboardMobileNav = ({
  ...
  return createPortal(
    <nav className="fixed bottom-0 left-0 right-0 z-[100] sm:hidden pb-[env(safe-area-inset-bottom)]">
      ...
      <div className="relative flex items-center gap-1 overflow-x-auto no-scrollbar px-2 py-2 min-h-[72px]">
        {tabs.map((tab) => {
          const Icon = tab.icon;
          ...
          return (
            <button
              ...
              className={cn(
                "relative flex min-w-max shrink-0 flex-col items-center justify-center gap-0.5 px-2.5 py-1.5 transition-all duration-200",
