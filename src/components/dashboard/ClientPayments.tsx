    ...
    <div className="space-y-4 sm:space-y-6 animate-fade-in">
                        ...
                        <DialogContent className="max-w-sm sm:max-w-md">
                          <DialogHeader>
                            ...
                            <DialogDescription className="text-sm">
                              Pay {selectedPayment?.currency}
                              {selectedPayment?.amount.toLocaleString()} to{" "}
                              {selectedPayment?.artistName}
                            </DialogDescription>
                          </DialogHeader>
      ...
      {payments.length === 0 && (
        <div className="text-center py-12 sm:py-16 bg-muted/30 rounded-lg border border-dashed">
          ...
          <h3 className="text-sm sm:text-lg font-medium text-muted-foreground mb-1 sm:mb-2">
            No payments yet
          </h3>
