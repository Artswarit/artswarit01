...
const EarningsChart = memo(
  ({ data, period, onPeriodChange }: EarningsChartProps) => {
    return (
      <Card className="overflow-hidden border-border/40 shadow-xl shadow-black/5 rounded-[2rem] bg-white/80 dark:bg-card/80 backdrop-blur-md">
        ...
        <CardContent className="p-4 sm:p-10">
          <div className="h-[350px] sm:h-[450px] w-full animate-in fade-in duration-1000">
            <Suspense
              fallback={
                <div className="h-full flex items-center justify-center text-sm font-bold text-muted-foreground/50 uppercase tracking-widest">
