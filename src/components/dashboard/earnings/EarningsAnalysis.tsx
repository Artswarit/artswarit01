    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              variant="outline"
              className="flex items-center gap-2 h-12 px-6 rounded-xl font-bold border-border/40 hover:bg-muted/50 transition-all shadow-sm"
            >
              <Download size={18} />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
        ...
        <Card className="rounded-[2rem] border-border/40 shadow-xl shadow-black/5 bg-white/80 backdrop-blur-md">
          ...
          <CardContent>
            <div className="text-4xl font-black tracking-tighter text-amber-600">
              ₹33,000
            </div>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
            <div className="space-y-1">
              ...
              <CardDescription className="text-sm font-medium">
                Track your monthly earnings trend
              </CardDescription>
            </div>
          ...
          <CardContent className="p-6 sm:p-10">
            ...
            <div className="grid grid-cols-2 gap-3 mt-8">
              {revenueSourcesData.map((item) => (
                <div
                  key={item.name}
                  className="p-4 rounded-2xl bg-muted/20 border border-border/10"
                >
              ...
              <div className="px-6 sm:px-10 pt-6">
                <div className="overflow-x-auto no-scrollbar -mx-4 px-4 sm:mx-0 sm:px-0">
                  <TabsList className="flex w-full p-1.5 bg-muted/30 rounded-2xl h-auto min-h-[56px] items-stretch gap-1">
                    <TabsTrigger
                      value="transactions"
                      className="flex-1 min-w-[120px] rounded-xl font-black text-[10px] uppercase tracking-widest data-[state=active]:bg-white data-[state=active]:shadow-sm transition-all py-3"
                    >
                      Recent Transactions
                    </TabsTrigger>
                    <TabsTrigger
              ...
              >
                <div className="divide-y divide-border/5">
                  {recentTransactions.map((transaction) => (
                    <div
                      key={transaction.id}
                      className="px-6 sm:px-10 py-5 hover:bg-muted/5 transition-colors group"
                    >
                        ...
                        <div className="text-right space-y-1">
                          ...
                          <div className="flex justify-end">
                            {transaction.status === "completed" ? (
                              <span className="text-[10px] font-black uppercase tracking-widest text-green-600 bg-green-50 px-2 py-0.5 rounded-md">
                                Completed
                              </span>
                            ) : (
                ...
                <div className="px-6 sm:px-10 py-6 mt-auto border-t border-border/10">
                  <Button
                    variant="outline"
                    className="w-full h-12 rounded-xl font-black text-[10px] uppercase tracking-widest border-border/40 hover:bg-muted/50 transition-all"
                  >
              ...
              >
                ...
                <div className="bg-muted/10 px-6 sm:px-10 py-6 mt-auto border-t border-border/10">
                  <div className="flex items-center gap-3 text-[10px] font-bold text-muted-foreground uppercase tracking-widest mb-4 leading-relaxed">
                    ...
                    <span>
                      Payouts are processed on the 1st and 15th of every month.
                    </span>
                  </div>
                  <Button
                    variant="outline"
