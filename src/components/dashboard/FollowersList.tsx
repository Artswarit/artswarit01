  ...
  useEffect(() => {
    ...
    async function fetchFollowers() {
      ...
      try {
        ...
        const normalized: FollowerProfile[] = (profilesData || []).map(
          (row: any) => ({
            id: row.id,
      ...
      <CardContent>
        ...
        <div className="flex flex-col items-center justify-center py-12 text-center space-y-4 rounded-2xl border-2 border-dashed border-border/40 bg-muted/5">
            ...
            <p className="text-sm text-muted-foreground max-w-[200px]">
              You don't have any followers yet. As clients follow you, they'll
              appear here.
            </p>
          </div> :
        ...
        <div className="space-y-3 max-h-[500px] overflow-y-auto pr-2 no-scrollbar">
          ...
          <div
            ...
            navigate(
              ...
              `/profile/${follower.id}`
            ...
            } role="button" tabIndex={0} onKeyDown={(e) => {if (e.key === "Enter" || e.key === " ") {e.preventDefault();(() => navigate(follower.role === "artist" ? `/artist/${follower.id}` : `/profile/${follower.id}`))(e);}}}>
                ...
                <div className="flex items-center gap-4 min-w-0">
                  ...
                  <Badge
                    variant="secondary"
                    className="text-[10px] px-2 py-0 h-5 font-black uppercase tracking-wider bg-primary/10 text-primary border-none">
