  ...
  const saveProfile = async (e?: React.MouseEvent) => {
    ...
    if (!formData.country) {
      toast({
        ...
        description: "Please select your country to set your local currency",
      });
      return;
    }
      ...
      <Card className="overflow-hidden">
        ...
        <CardContent className="pt-4">
          <p className="text-xs text-muted-foreground">
            Recommended size: 1200x300 pixels. This banner will appear on your
            public profile.
          </p>
        </CardContent>
      </Card>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            Fill in your profile to start discovering and working with artists
          </p>
        </div>
        <Button
          onClick={saveProfile}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        ...
        <Card className="transition-all duration-300 hover:shadow-md">
          <CardHeader className="pb-3 sm:pb-4">
            ...
            <CardDescription className="text-xs sm:text-sm">
              Your country sets your local currency
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div>
            ...
            <div className="p-4 border rounded-lg bg-muted/20">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    {[formData.city, selectedCountry?.country_name]
                      .filter(Boolean)
