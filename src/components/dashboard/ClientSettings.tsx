      ...
      try {
        ...
        if (profileData) {
          ...
          setNotificationSettings({
            ...
            projectUpdateNotifications:
              profileData.project_update_notifications ?? true,
      ...
      try {
        ...
        if (data) {
          ...
          setNotificationSettings({
            ...
            projectUpdateNotifications:
              data.project_update_notifications ?? true,
      ...
      const { error } = await supabase
        ...
        .update({
          ...
          project_update_notifications:
            notificationSettings.projectUpdateNotifications,
            ...
            <div className="flex items-center gap-6 p-4 rounded-2xl bg-primary/5 border border-primary/10">
              ...
              <div className="flex-1 space-y-1">
                ...
                <div className="flex mt-2">
                  <Badge
                    variant="secondary"
                    className="bg-primary/10 text-primary hover:bg-primary/20 border-none font-bold px-3 py-1 rounded-lg"
                  >
                    Client Account
                  </Badge>
                </div>
        ...
        <Card className="rounded-[2rem] border-primary/10 shadow-xl backdrop-blur-md bg-background/95 overflow-hidden transition-all duration-300 hover:shadow-2xl hover:border-primary/20">
          ...
          <CardContent className="space-y-6 pt-6 sm:pt-8">
            <div className="space-y-2">
              <Label
                htmlFor="timezone"
                className="text-sm font-bold ml-1 flex items-center gap-2"
              >
                ...
                <SelectContent className="max-h-[300px] rounded-2xl border-primary/10 shadow-2xl">
                  {TIMEZONES.map((tz) => (
                    <SelectItem
                      key={tz.value}
                      value={tz.value}
                      className="min-h-[48px] rounded-xl focus:bg-primary/5"
                    >
                      {tz.label}
                    </SelectItem>
                  ))}
          ...
          <CardContent className="space-y-6 pt-6 sm:pt-8">
            <div className="flex items-center justify-between group min-h-[56px] p-4 rounded-2xl hover:bg-primary/5 transition-colors">
              <div className="flex-1 space-y-1">
                ...
                <p className="text-xs sm:text-sm text-muted-foreground/80 font-medium">
                  Make your profile visible to artists
                </p>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between group min-h-[56px] p-4 rounded-2xl hover:bg-primary/5 transition-colors">
              <div className="flex-1 space-y-1">
                ...
                <p className="text-xs sm:text-sm text-muted-foreground/80 font-medium">
                  Display project stats to artists
                </p>
              </div>
              <Switch
                id="show-activity"
            ...
            <div className="flex items-center justify-between group min-h-[56px] p-4 rounded-2xl hover:bg-primary/5 transition-colors">
              <div className="flex-1 space-y-1">
                <Label
                  ...
                  className="text-base sm:text-lg font-bold cursor-pointer flex items-center gap-2"
                >
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  setNotificationSettings((prev) => ({
                    ...prev,
                    projectUpdateNotifications: checked,
                  }))
                }
              />
            </div>
            ...
            {loadingSessions ? (
              ...
              <div className="text-center py-8 text-muted-foreground">
                ...
                <p className="text-xs mt-1">
                  Sessions will appear here when you log in from different
                  devices
                </p>
              </div>
            ) : (
                ...
                <div className="space-y-3">
                  {sessions.map((session) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div
                          className={`p-2 rounded-full ${session.is_current ? "bg-primary/10" : "bg-muted"}`}
                        >
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action cannot be undone. All your projects, messages, and
