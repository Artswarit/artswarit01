          ...
          <div className="flex justify-between items-center gap-4">
            <div className="space-y-1">
              ...
              <CardDescription className="text-sm font-medium">
                Tell others about yourself and your art
              </CardDescription>
            </div>
            {isEditing ? (
              <Button
                onClick={onSave}
                className="flex items-center gap-2 h-12 px-6 rounded-xl font-black text-[10px] uppercase tracking-widest bg-primary text-primary-foreground shadow-lg shadow-primary/20 hover:scale-[1.02] active:scale-[0.98] transition-all"
              >
        ...
        <CardContent className="p-6 sm:p-10 space-y-8 sm:space-y-6">
          {isEditing ? (
            ...
            <div className="space-y-6">
              <div className="space-y-1">
                <h3 className="font-black text-3xl tracking-tighter">
                  {profile.displayName}
                </h3>
              ...
              <p className="text-base font-medium leading-relaxed text-muted-foreground whitespace-pre-wrap">
                {profile.bio ||
                  "No bio yet. Tell the world about your artistic journey!"}
              </p>
            </div>
          )}
        </CardContent>
