...
export default function AdminDashboard() {
  ...
  const body = (() => {
    switch (active) {
      ...
      case "escrow":      return <><SectionHeader title="Escrow" subtitle="Funded, held, and released milestone funds." /><AdminEscrow /></>;
      ...
      case "audit":       return <><SectionHeader title="Audit log" subtitle="Every admin moderation, dispute, and account action." /><AuditLog /></>;
