        ...
        <CardContent>
          {isPayoutsEnabled ? (
            <div className="space-y-3">
              ...
              <Button variant="outline" className="w-full sm:w-auto mt-4 h-12 sm:h-10 min-h-[48px] sm:min-h-[40px]" onClick={() => setDialogOpen(true)}>
                Update Details
              </Button>
            </div>
          ) : (
            <Button className="w-full sm:w-auto h-12 sm:h-11 min-h-[48px] sm:min-h-[44px]" onClick={() => setDialogOpen(true)}>
              Enable Payments
            </Button>
          )}
        </CardContent>
