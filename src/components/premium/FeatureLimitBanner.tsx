...
export function FeatureLimitBanner({
  ...
  return (
    <Card
      className={`border ${isAtLimit ? "border-orange-300 bg-orange-50" : "border-yellow-200 bg-yellow-50"}`}
    >
      <CardContent className="py-4">
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 flex-1">
            <div
              className={`p-2 rounded-lg ${isAtLimit ? "bg-orange-100 text-orange-600" : "bg-yellow-100 text-yellow-600"}`}
            >
              {icon}
            </div>
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between mb-1">
                <span
                  className={`text-sm font-medium ${isAtLimit ? "text-orange-700" : "text-yellow-700"}`}
                >
                  {isAtLimit
