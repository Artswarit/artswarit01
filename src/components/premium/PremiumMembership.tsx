...
const PremiumMembership = () => {
  ...
  const { isActive, subscriptionTier, loading } = usePremiumSubscription(
    user?.id,
  );
  const {
    isProArtist,
      ...
      <div className="text-center space-y-4">
        ...
        {!isProArtist && (
          <p className="text-muted-foreground max-w-xl mx-auto text-center">
            Turn your creativity into meaningful work. Start free, upgrade when
            ready.
          </p>
        )}
      </div>
      ...
      {isProArtist ? (
            ...
            <CardContent className="relative z-10">
              ...
              <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                ...
                <p className="text-sm text-green-600 mt-1">
                  As a Pro Artist, you don't pay any platform fees. Every rupee
                  from your milestones goes directly to you!
                </p>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="space-y-6">
          ...
          <div className="text-center space-y-2 text-sm text-muted-foreground">
            <p>
              No contracts. Cancel anytime. Pro artists get hired 3× faster on
              average.
            </p>
          </div>
        </div>
