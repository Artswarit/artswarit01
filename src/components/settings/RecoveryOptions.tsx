  ...
  const generateNewCodes = async (e?: React.MouseEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "Save these codes somewhere safe. They can only be shown once.",
      });
    } catch (err: any) {
      toast({
        title: "Error",
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Add a phone number for account recovery. We'll use this if you lose
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Generate one-time use codes for account recovery. Each code can only
            be used once.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
