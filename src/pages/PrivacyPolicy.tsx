        ...
        <div className="container mx-auto px-4 sm:px-6 max-w-4xl">
          ...
          <div className="text-center mb-12 sm:mb-16 space-y-4">
            ...
            <p className="text-base text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              ...
              2000, and the RBI guidelines for payment aggregators.
            </p>
          </div>
          ...
          <Card className="mb-6 border-primary/10 shadow-md">
            <CardContent className="p-6 sm:p-8">
              ...
              <div className="space-y-3 text-sm text-muted-foreground leading-relaxed pl-8">
                <p>
                  The <strong>Data Fiduciary</strong> (as defined under the DPDP
              ...
              <div className="space-y-4 text-sm text-muted-foreground leading-relaxed pl-8">
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-1.5">
                    <li>
                      <strong>Account Registration:</strong> Full name, email
                      address, password (hashed), role (Artist/Client), country,
                      city
                    </li>
                    <li>
                      <strong>Profile Information:</strong> Bio, avatar image,
                      portfolio links, social media links, skills, categories
                    </li>
                    <li>
                      <strong>KYC/Verification:</strong> Phone number, tax
                      identification (PAN/GST), bank account details for artist
                      payouts
                    </li>
                    <li>
                      <strong>Communications:</strong> Messages sent via the
                      platform's chat system, project descriptions, milestone
                      specifications
                    </li>
                    <li>
                      <strong>Payment Data:</strong> Billing address,
                      transaction records. Note: We do NOT store credit/debit
                      card numbers — this is handled by our PCI-DSS Level 1
                      compliant partner (Razorpay).
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-1.5">
                    <li>
                      ...
                      operating system, screen resolution, device identifiers
                    </li>
                    <li>
                      <strong>Usage Data:</strong> Pages visited, click
                      patterns, session duration, search queries, artwork
                      views/likes
                    </li>
                    <li>
                      <strong>Network Data:</strong> IP address, approximate
                      location (city-level), referral URLs
                    </li>
                    <li>
                      <strong>Cookies & Tracking:</strong> Session cookies
                      (essential), analytics cookies (with consent). See Section
                      8 below.
                    </li>
                  </ul>
                </div>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm border-collapse">
                    ...
                    <tbody>
                      ...
                      <tr className="border-b border-border/50">
                        <td className="py-3 px-4">
                          Facilitating artist-client transactions
                        </td>
                      ...
                      <tr className="border-b border-border/50">
                        ...
                        <td className="py-3 px-4">
                          Legal obligation (RBI PA/PG Guidelines)
                        </td>
                      </tr>
                      <tr className="border-b border-border/50">
                        <td className="py-3 px-4">
                        ...
                        <td className="py-3 px-4">
                          Legal obligation (RBI KYC norms)
                        </td>
                      </tr>
                      <tr className="border-b border-border/50">
                        <td className="py-3 px-4">
                        ...
                        <td className="py-3 px-4">
                          Legal obligation (IT Rules 2021)
                        </td>
                      </tr>
                      <tr className="border-b border-border/50">
                        <td className="py-3 px-4">
          ...
          <Card className="mb-6 border-primary/10 shadow-md">
            <CardContent className="p-6 sm:p-8">
              ...
              <div className="space-y-3 text-sm text-muted-foreground leading-relaxed pl-8">
                <p>
                  <strong>We do not sell your personal data. Ever.</strong>
                </p>
                <p>
                ...
                <ul className="list-disc pl-5 space-y-2">
                  <li>
                    <strong>Payment Processor (Razorpay):</strong> To process
                    payments, manage escrow, and comply with RBI mandates.
                    Razorpay is PCI-DSS Level 1 certified.
                  </li>
                  <li>
                    <strong>Cloud Hosting (Supabase / AWS):</strong> For data
                    storage and infrastructure. All data is encrypted at rest
                    and in transit.
                  </li>
                  <li>
                    <strong>Authentication (Supabase Auth):</strong> For secure
                    user authentication including email verification and
                    password management.
                  </li>
                  <li>
                    <strong>Analytics (aggregate, anonymised):</strong> We may
                    use anonymised, aggregated data for platform performance
                    analysis. This data cannot identify individual users.
                  </li>
                  <li>
                    <strong>Law Enforcement:</strong> We will disclose personal
                    data if required by a court order, government directive, or
                    law enforcement request under applicable Indian law.
                  </li>
                </ul>
              </div>
            </CardContent>
            ...
            <CardContent className="p-6 sm:p-8">
              ...
              <div className="space-y-3 text-sm text-muted-foreground leading-relaxed pl-8">
                <ul className="list-disc pl-5 space-y-2">
                  ...
                  <li>
                    <strong>Password Storage:</strong> Passwords are hashed
                    using industry-standard bcrypt algorithms and are never
                  ...
                  <li>
                    <strong>Infrastructure:</strong> Our platform is hosted on
                    Supabase (backed by AWS infrastructure) with data centres
                    that comply with SOC 2 Type II and ISO 27001 standards.
                  </li>
                  <li>
                    <strong>Payment Security:</strong> Card and bank account
                    data is handled exclusively by Razorpay (PCI-DSS Level 1).
                    Artswarit does not have access to raw card numbers.
                  </li>
                </ul>
              </div>
            </CardContent>
                  ...
                  <table className="w-full text-sm border-collapse">
                    ...
                    <tbody>
                      ...
                      <tr className="border-b border-border/50">
                        ...
                        <td className="py-3 px-4">
                          7 years (Income Tax Act, 1961)
                        </td>
                      </tr>
                      <tr className="border-b border-border/50">
                        <td className="py-3 px-4">KYC documents</td>
                        <td className="py-3 px-4">
                          5 years post relationship end (RBI KYC norms)
                        </td>
                      </tr>
                      <tr className="border-b border-border/50">
          ...
          <Card className="mb-6 border-emerald-200 dark:border-emerald-900/40 shadow-md">
            <CardContent className="p-6 sm:p-8">
              ...
              <div className="space-y-3 text-sm text-muted-foreground leading-relaxed pl-8">
                <p>
                  Under the Digital Personal Data Protection Act, 2023, you (the
                  "Data Principal") have the following rights:
                </p>
                <ul className="list-disc pl-5 space-y-2">
                  <li>
                    <strong>Right to Access:</strong> You may request a summary
                    of the personal data processed about you and the processing
                    activities.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    consent for data processing at any time. Withdrawal does not
                    affect the lawfulness of processing done prior to
                    withdrawal.
                  </li>
                  <li>
                    <strong>Right to Grievance Redressal:</strong> You may file
                    a complaint with our Grievance Officer or the Data
                ...
                <p>
                  ...
                  or our Grievance Officer via the{" "}
                  <Link
                    to="/contact-us"
                    className="text-primary font-semibold underline underline-offset-2"
                  >
          ...
          <Card className="mb-6 border-primary/10 shadow-md">
            <CardContent className="p-6 sm:p-8">
              ...
              <div className="space-y-3 text-sm text-muted-foreground leading-relaxed pl-8">
                  ...
                  <table className="w-full text-sm border-collapse">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td className="py-3 px-4">
                          Understanding usage patterns, improving UX
                        </td>
                        <td className="py-3 px-4">Optional (consent-based)</td>
                      </tr>
                    </tbody>
                ...
                <p>
                  We do <strong>not</strong> use third-party advertising
                  trackers or sell data to advertisers. You may manage cookie
          ...
          <Card className="mb-6 border-primary/10 shadow-md">
            <CardContent className="p-6 sm:p-8">
              ...
              <div className="space-y-3 text-sm text-muted-foreground leading-relaxed pl-8">
                <p>
                  Artswarit is not intended for use by individuals under the age
                  of <strong>18 years</strong>. We do not knowingly collect
                  personal data from minors. In compliance with Section 9 of the
                  DPDP Act, 2023, processing of a child's personal data requires
                  verifiable parental consent.
                </p>
                <p>
                  If we become aware that we have collected data from a child
                  without appropriate consent, we will take immediate steps to
                  delete such data.
                </p>
              </div>
            </CardContent>
            ...
            <CardContent className="p-6 sm:p-8">
              ...
              <div className="space-y-3 text-sm text-muted-foreground leading-relaxed pl-8">
                <p>
                  ...
                  Material changes will be notified via email and/or a prominent
            ...
            <CardContent className="p-6 sm:p-8">
              ...
              <div className="space-y-3 text-sm text-muted-foreground leading-relaxed pl-8">
                ...
                <div className="p-4 rounded-xl bg-muted/40 border border-border/50 space-y-1">
                  ...
                  <p>
                    <strong>Regulatory Authority:</strong> Data Protection Board
                    of India (once constituted under DPDP Act, 2023)
                  </p>
                </div>
              </div>
            </CardContent>
