        ...
        <div className="container mx-auto px-4 sm:px-6 max-w-4xl">
          ...
          <div className="text-center mb-12 sm:mb-16 space-y-4">
            ...
            <p className="text-base text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Whether you have a question, need support, or wish to escalate a
              concern — we're committed to resolving it promptly and
              transparently.
            </p>
          </div>
            ...
            <Card className="border-primary/10 shadow-md hover:shadow-lg transition-shadow text-center">
              <CardContent className="p-6 space-y-3">
                ...
                <a
                  ...
                  className="text-primary font-semibold text-sm underline underline-offset-2 block"
                >
            ...
            <CardContent className="p-6 sm:p-10">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-xs font-bold text-red-600 uppercase tracking-widest">
                    IT Rules 2021, Rule 3(2) & Rule 4 · Consumer Protection Act,
                    2019
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-6 text-sm text-muted-foreground leading-relaxed">
                <p>
                  ...
                  amended through 2026), and the Consumer Protection Act, 2019,
                  Artswarit has established a formal Grievance Redressal
                  Mechanism with a designated Nodal Officer.
                </p>
                ...
                <div>
                  ...
                  <ol className="list-decimal pl-5 space-y-2">
                    <li>
                      <strong>Email your complaint</strong> to{" "}
                      <a
                        href="mailto:grievance@artswarit.com"
                      ...
                      <ul className="list-disc pl-5 mt-1 space-y-1">
                        ...
                        <li>
                          Any relevant project/milestone IDs, screenshots, or
                    ...
                    <li>
                      ...
                      acknowledgement with a ticket number within{" "}
                      <strong>24 hours</strong> of receipt.
                    </li>
                    <li>
                      <strong>Investigation:</strong> The Grievance Officer will
                      investigate the matter and may contact you for additional
                      information.
                    </li>
                    <li>
                      <strong>Resolution:</strong> A final resolution will be
                      communicated within <strong>15 days</strong> of receipt of
                      the complaint, in compliance with IT Rules 2021.
                    </li>
                    <li>
                      <strong>Escalation:</strong> If unsatisfied with the
                      resolution, you may escalate the matter by writing to{" "}
                      <a
                        href="mailto:escalation@artswarit.com"
                        className="text-primary font-semibold underline underline-offset-2"
                      >
                        escalation@artswarit.com
                      </a>{" "}
                      or approach the appropriate consumer forum or regulatory
                      authority.
                    </li>
                  </ol>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-1.5">
                    <li>
                      Payment disputes, refund delays, or escrow-related queries
                    </li>
                    <li>
                      Content takedown requests (including CSAM, IP violations,
                      defamatory content)
                    </li>
                    <li>Account suspension or termination appeals</li>
                    <li>
                      Data privacy and personal data requests (access,
                      correction, deletion)
                    </li>
                    <li>
                      Platform misuse, harassment, or fraudulent activity
                      reports
                    </li>
                    <li>
                      Any other concern related to the use of Artswarit services
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <Card className="mb-6 border-primary/10 shadow-md">
            <CardContent className="p-6 sm:p-8">
              ...
              <div className="space-y-3 text-sm text-muted-foreground leading-relaxed pl-8">
                <p>
                  Artswarit's grievance redressal mechanism is established in
                  compliance with:
                </p>
                <ul className="list-disc pl-5 space-y-1.5">
                  <li>
                    <strong>Information Technology Act, 2000</strong> — Section
                    79 (Intermediary due diligence)
                  </li>
                  <li>
                    <strong>
                    ...
                    (as amended through 2026) — Rule 3(2), Rule 4
                  </li>
                  <li>
                    <strong>Consumer Protection Act, 2019</strong> — Consumer
                  ...
                  <li>
                    <strong>
                      RBI Master Directions on Payment Aggregators, 2026
                    </strong>{" "}
                    — Customer grievance redressal for payment-related issues
                  </li>
                </ul>
              </div>
            </CardContent>
