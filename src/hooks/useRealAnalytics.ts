    ...
    try {
      ...
      const viewsGrowth =
        previousViewsCount > 0
          ? Math.round(
              ((recentViewsCount - previousViewsCount) / previousViewsCount) *
                100,
            )
          : recentViewsCount > 0
            ? 100
      ...
      const likesGrowth =
        previousLikesCount > 0
          ? Math.round(
              ((recentLikesCount - previousLikesCount) / previousLikesCount) *
                100,
            )
          : recentLikesCount > 0
            ? 100
      ...
      const recentRevenueTotal = (recentRevenue.data || []).reduce(
        (sum, r) => sum + Number(r.amount),
        0,
      );
      ...
      const revenueGrowth =
        previousRevenueTotal > 0
          ? Math.round(
              ((recentRevenueTotal - previousRevenueTotal) /
      ...
      const followersGrowth =
        previousFollowersCount > 0
          ? Math.round(
              ((recentFollowersCount - previousFollowersCount) /
